...
public class VoterVerticalTabAdapter implements TabAdapter {

    private Context context;
    private List<String> classifyList;

    public VoterVerticalTabAdapter(Context context) {
        this.context = context;
        classifyList  = new ArrayList<>();
        Collections.addAll(classifyList,"Snack","Frunt","Drink","Others");
    }
...
//    }
    ...
    public TabView.TabTitle getTitle(int position) {
        return new TabView.TabTitle.Builder()
                ...
                .setTextColor(context.getResources().getColor(R.color.colorPrimaryDark), context.getResources().getColor(R.color.color7e7e7e))
                .build();
    }
